...
_MUSCLE_BG = {
    ...
    "小胸筋":     "rgba(25,135,84,0.12)",
    "前鋸筋":     "rgba(25,135,84,0.12)",
    # 背中
    "広背筋":     "rgba(13,110,253,0.18)",
    "僧帽筋":     "rgba(13,110,253,0.14)",
    "菱形筋":     "rgba(13,110,253,0.12)",
    "脊柱起立筋": "rgba(108,117,125,0.25)",
    "多裂筋":     "rgba(108,117,125,0.20)",
    # 肩
    "三角筋":     "rgba(32,201,151,0.18)",
    "三角筋前部": "rgba(32,201,151,0.18)",
    "三角筋中部": "rgba(32,201,151,0.18)",
    "三角筋後部": "rgba(32,201,151,0.15)",
    "棘下筋":     "rgba(32,201,151,0.12)",
    "棘上筋":     "rgba(32,201,151,0.12)",
    "小円筋":     "rgba(32,201,151,0.12)",
    # 腕
    "上腕二頭筋": "rgba(214,51,132,0.18)",
    "上腕三頭筋": "rgba(255,193,7,0.18)",
    "上腕筋":     "rgba(214,51,132,0.14)",
    "腕橈骨筋":   "rgba(214,51,132,0.12)",
    "前腕屈筋群": "rgba(214,51,132,0.10)",
    "前腕伸筋群": "rgba(255,193,7,0.12)",
    # 体幹
    "腹直筋":     "rgba(13,202,240,0.18)",
    "腹斜筋":     "rgba(13,202,240,0.15)",
    "外腹斜筋":   "rgba(13,202,240,0.15)",
    "内腹斜筋":   "rgba(13,202,240,0.12)",
    "腹横筋":     "rgba(13,202,240,0.10)",
    "腸腰筋":     "rgba(253,126,20,0.15)",
    # 臀部
    "大臀筋":     "rgba(220,53,69,0.18)",
    "中臀筋":     "rgba(220,53,69,0.14)",
    "小臀筋":     "rgba(220,53,69,0.10)",
    # 大腿
    "大腿四頭筋": "rgba(111,66,193,0.18)",
    "大腿直筋":   "rgba(111,66,193,0.15)",
    "外側広筋":   "rgba(111,66,193,0.14)",
    "内側広筋":   "rgba(111,66,193,0.14)",
    "ハムストリングス": "rgba(253,126,20,0.18)",
    "大腿二頭筋": "rgba(253,126,20,0.16)",
    "半腱様筋":   "rgba(253,126,20,0.14)",
    "内転筋群":   "rgba(111,66,193,0.12)",
    "大内転筋":   "rgba(111,66,193,0.12)",
    # 下腿
    "腓腹筋":     "rgba(102,16,242,0.18)",
    "ヒラメ筋":   "rgba(102,16,242,0.15)",
    "カーフ":     "rgba(102,16,242,0.18)",
    "前脛骨筋":   "rgba(102,16,242,0.12)",
}
