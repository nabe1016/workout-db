...
_MUSCLE_BG = {
    ...
    # 肩  — teal tint
    "三角筋":     "rgba(100,210,255,0.14)",
    "三角筋前部": "rgba(100,210,255,0.14)",
    "三角筋中部": "rgba(100,210,255,0.14)",
    "三角筋後部": "rgba(100,210,255,0.11)",
    "棘下筋":     "rgba(100,210,255,0.09)",
    "棘上筋":     "rgba(100,210,255,0.09)",
    "小円筋":     "rgba(100,210,255,0.09)",
    # 腕  — pink / yellow tint
    "上腕二頭筋": "rgba(255,55,95,0.14)",
    "上腕三頭筋": "rgba(255,214,10,0.14)",
    "上腕筋":     "rgba(255,55,95,0.10)",
    "腕橈骨筋":   "rgba(255,55,95,0.09)",
    "前腕屈筋群": "rgba(255,55,95,0.08)",
    "前腕伸筋群": "rgba(255,214,10,0.09)",
    # 体幹  — cyan / orange tint
    "腹直筋":     "rgba(100,210,255,0.13)",
    "腹斜筋":     "rgba(100,210,255,0.11)",
    "外腹斜筋":   "rgba(100,210,255,0.11)",
    "内腹斜筋":   "rgba(100,210,255,0.09)",
    "腹横筋":     "rgba(100,210,255,0.08)",
    "腸腰筋":     "rgba(255,159,10,0.12)",
    # 臀部  — red tint
    "大臀筋":     "rgba(255,69,58,0.14)",
    "中臀筋":     "rgba(255,69,58,0.10)",
    "小臀筋":     "rgba(255,69,58,0.08)",
    # 大腿  — indigo / orange tint
    "大腿四頭筋": "rgba(94,92,230,0.16)",
    "大腿直筋":   "rgba(94,92,230,0.12)",
    "外側広筋":   "rgba(94,92,230,0.11)",
    "内側広筋":   "rgba(94,92,230,0.11)",
    "ハムストリングス": "rgba(255,159,10,0.14)",
