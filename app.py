...
# Primary muscle → card background tint
# 10 distinct iOS system colors — each group is visually unique
_MUSCLE_BG = {
    # 胸  — green
    "大胸筋":          "rgba(48,209,88,0.15)",
    "小胸筋":          "rgba(48,209,88,0.10)",
    "前鋸筋":          "rgba(48,209,88,0.10)",
    # 背中  — blue
    "広背筋":          "rgba(10,132,255,0.16)",
    "僧帽筋":          "rgba(10,132,255,0.12)",
    "菱形筋":          "rgba(10,132,255,0.10)",
    "脊柱起立筋":      "rgba(10,132,255,0.10)",
    "多裂筋":          "rgba(10,132,255,0.08)",
    # 肩  — cyan (50,173,230)
    "三角筋":          "rgba(50,173,230,0.15)",
    "三角筋前部":      "rgba(50,173,230,0.15)",
    "三角筋中部":      "rgba(50,173,230,0.15)",
    "三角筋後部":      "rgba(50,173,230,0.11)",
    "棘下筋":          "rgba(50,173,230,0.09)",
    "棘上筋":          "rgba(50,173,230,0.09)",
    "小円筋":          "rgba(50,173,230,0.09)",
    # 腕（二頭）— pink
    "上腕二頭筋":      "rgba(255,55,95,0.15)",
    "上腕筋":          "rgba(255,55,95,0.10)",
    "腕橈骨筋":        "rgba(255,55,95,0.09)",
    "前腕屈筋群":      "rgba(255,55,95,0.08)",
    # 腕（三頭）— yellow
    "上腕三頭筋":      "rgba(255,214,10,0.15)",
    "前腕伸筋群":      "rgba(255,214,10,0.09)",
    # 体幹  — mint (0,199,190)  ← 肩と区別するため別色
    "腹直筋":          "rgba(0,199,190,0.15)",
    "腹斜筋":          "rgba(0,199,190,0.12)",
    "外腹斜筋":        "rgba(0,199,190,0.12)",
    "内腹斜筋":        "rgba(0,199,190,0.09)",
    "腹横筋":          "rgba(0,199,190,0.08)",
    "腸腰筋":          "rgba(0,199,190,0.10)",
    # 臀部  — red
    "大臀筋":          "rgba(255,69,58,0.15)",
    "中臀筋":          "rgba(255,69,58,0.11)",
    "小臀筋":          "rgba(255,69,58,0.08)",
    # 大腿四頭筋  — indigo
    "大腿四頭筋":      "rgba(94,92,230,0.16)",
    "大腿直筋":        "rgba(94,92,230,0.12)",
    "外側広筋":        "rgba(94,92,230,0.11)",
    "内側広筋":        "rgba(94,92,230,0.11)",
    "内転筋群":        "rgba(94,92,230,0.10)",
    "大内転筋":        "rgba(94,92,230,0.10)",
    # ハムストリングス  — orange
    "ハムストリングス": "rgba(255,159,10,0.15)",
    "大腿二頭筋":      "rgba(255,159,10,0.12)",
    "半腱様筋":        "rgba(255,159,10,0.11)",
    # 下腿  — purple
    "腓腹筋":          "rgba(191,90,242,0.14)",
    "ヒラメ筋":        "rgba(191,90,242,0.12)",
    "カーフ":          "rgba(191,90,242,0.14)",
    "前脛骨筋":        "rgba(191,90,242,0.10)",
}

# Legend data for template rendering (label → display color)
MUSCLE_LEGEND = [
    {"label": "胸",           "rgb": "48,209,88"},
    {"label": "背中",         "rgb": "10,132,255"},
    {"label": "肩",           "rgb": "50,173,230"},
    {"label": "二頭筋",       "rgb": "255,55,95"},
    {"label": "三頭筋",       "rgb": "255,214,10"},
    {"label": "体幹",         "rgb": "0,199,190"},
    {"label": "臀部",         "rgb": "255,69,58"},
    {"label": "大腿四頭筋",   "rgb": "94,92,230"},
    {"label": "ハムスト",     "rgb": "255,159,10"},
    {"label": "下腿",         "rgb": "191,90,242"},
]

app.jinja_env.globals['muscle_bg']     = lambda m: _MUSCLE_BG.get(m or "", "")
app.jinja_env.globals['muscle_legend'] = MUSCLE_LEGEND
